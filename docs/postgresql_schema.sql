...
CREATE INDEX IF NOT EXISTS idx_messages_turn_role ON session_messages(session_id, turn_id, role);
CREATE INDEX IF NOT EXISTS idx_messages_external ON session_messages(external_message_id);
